...
rosserver.app.put('/nodes/:nodeId/subscribers/:subscriberId', function(req, res){
  ...
  if (subscriber === undefined) {
    ...
    if (req.body.Message === undefined && req.body.messageType) {
      ...
      var packageName = messageTypeComponents[0]
      var messageType = messageTypeComponents[1]
      var pkg = require('../../web/' + packageName)
      req.body.Message = pkg[messageType]
      console.log(req.body)
    }
