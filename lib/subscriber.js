...
ros.Subscriber.prototype.publisherUpdate = function(publishers, callback) {
  ...
  for (var i = 0; i < publishers.length; i++) {
    ...
    client.methodCall('requestTopic', [callerId, topic, [['TCPROS']]], function(error, value) {
      ...
      socket.on('data', function(data) {
        ...
        // var message = tcpros.getMessageFromBuffer(data, Message)
      ...
      var buffer = tcpros.getBufferFromConnectionHeader(connectionHeader)
      socket.write(buffer)
    })
  }
  callback(null)
